...
Sub CommandButton1_Click()
    ...
    End Select
    ' writes the weeknumber into our worksheet
...
Function checkuserform() As Boolean
    ...
    If lb_type.Value = "" Then
        MsgBox "Es wurde keine TŠtigkeitsart angegeben"
        checkuserform = False
        Exit Function
    ...
    If IsNull(lb_projects) Then
        MsgBox "Es wurde kein Projekt ausgewŠhlt"
        checkuserform = False
        Exit Function
    End If
    ...
    If IsNull(lb_workers) Then
        MsgBox " Es wurde keine Mitarbeiter ausgewŠhlt "
        checkuserform = False
        Exit Function
